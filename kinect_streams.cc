...
{
public: 
    KinectServer( int port, libfreenect2::SyncMultiFrameListener *listener );
    ~KinectServer( );
...
KinectServer::KinectServer( int port, libfreenect2::SyncMultiFrameListener
*listener ) : WebSocketServer( port ),
listener_(listener)
{
}
...
/// [registration setup]
  ...
  KinectServer es = KinectServer( 8080, &listener );
  es.run( );
